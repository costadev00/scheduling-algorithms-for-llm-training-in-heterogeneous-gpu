"""Generate PEFT-like heterogeneous DAG (2048 tasks, 8 procs) com interface de herança.
Permite --inherit-prefix para coerência (não usual para base), copiando colunas iniciais.
"""
...
def main():
    ...
    if inherit_power is not None and inherited_cols>0 and inherit_power.shape[1]>=inherited_cols:
    ...
    if inherit_bw is not None and inherited_cols>0 and inherit_bw.shape[0]>=inherited_cols:
