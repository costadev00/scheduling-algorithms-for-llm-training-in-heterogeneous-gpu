"""Generate a PEFT-like heterogeneous DAG with 2048 tasks and 32 processors.

Scaling of prior scenario generators. See 2048-8 / 2048-16 variants for rationale.
Default layers=7; structure & distributions unchanged.
"""
